...
@interface SKFNavigationController()<UIGestureRecognizerDelegate>

@end


@implementation SKFNavigationController


-(instancetype)initWithRootViewController:(UIViewController *)rootViewController {
    if (self = [super initWithRootViewController:rootViewController]) {
        [self setValue:[[SKFNavBar alloc] init] forKey:@"navigationBar"];
    }
    return self;
}
