...
@implementation SKFMiddleView

static SKFMiddleView *_shareInstance;

+ (instancetype)shareInstance {
    if (_shareInstance == nil) {
        _shareInstance = [SKFMiddleView middleView];
    }
...
+ (instancetype)middleView {
    ...
    SKFMiddleView *middleView = [[[NSBundle bundleForClass:self] loadNibNamed:@"SKFMiddleView" owner:nil options:nil] firstObject];
    return middleView;
}
